...
class Photu {
   ...
   * https://mott-img.b-cdn.net/q100-efalse-ptrue-fauto-w
   * https://mott-img.b-cdn.net/q100-efalse-ptrue-fauto-w500/
   */
  static transform(url, resolution = 500) {
   ...
   * @return {string}
   */
  static getUrlPrefix(resolution = 500) {
    let prefix = process.env.IMG_CDN_URL || 'https://mott-img.b-cdn.net/q100-efalse-ptrue-fauto-w';
    prefix += resolution;
    prefix += '/';
    return prefix;
  }
   ...
   * @return {string} url
   */
  static removeUrlPrefixes(url, resolution = 500) {
    const prefix = this.getUrlPrefix(resolution);
   ...
   * @return {boolean}
   */
  static isUrlPrefixed(url, resolution = 500) {
    const prefix = this.getUrlPrefix(resolution);
